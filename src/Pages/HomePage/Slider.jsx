      ...
      >
        ...
        <Carousel.Item>
          <img
            alt="."
            width="100%"
            src="https://images-eu.ssl-images-amazon.com/images/G/31/img21/MA2024/May/Casualwearhaul/Page/Topbanner/pc.gif"
          />
        </Carousel.Item>
        <Carousel.Item>
          <img
        ...
        <Carousel.Item>
          <img
            alt="."
            width="100%"
            src="https://m.media-amazon.com/images/G/31/img21/MA2024/May/Casualwearhaul/Page/Bxgy/workwear_3000x770._SX3000_QL85_FMpng_.png"
          />
        </Carousel.Item>
      </Carousel>
    </Stack>
